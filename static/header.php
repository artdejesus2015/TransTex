            ...
            <div class="collapse navbar-collapse navbar-menu-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="menu-main-menu-container">
                    <ul id="menu-main-menu-1" class="nav navbar-nav">
                        ...
                        <li class="current-menu-item current_page_item"><a href="about.php">About Us</a></li>
                ...
                <ul class="search-form-wrap">
                    <li>
                        <form class="navbar-form navbar-left navbar-search-form" role="search">
                            ...
                            <button type="submit" class="btn btn-transparent"><img src="images/search-icon.png"></button>
                        </form>
                    </li>
