<?php include 'header.php'; ?>
        ...
        <div class="banner bg-r-overlay banner-home" style="background-image: url('images/banner-home.jpg')">
            ...
            <div class="container-fluid">
                <div class="grid grid-box grid-intro-home">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-intro-home1.jpg')">
                        ...
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-intro-home2.jpg')">
                        ...
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-intro-home3.jpg')">
                ...
                <img src="images/logo-icon.png" class="logo-icon-img">
        ...
        <div class="section bg-r-overlay section-we-do" style="background-image: url('images/bg-we-do.jpg')">
            <div class="container">
                <div class="content">
                    <h2 class="title section-title title-white">watch how we do it</h2>

                    <div class="bg-r-overlay video-wrap" style="background-image: url('images/video-img.jpg')">
            ...
            <div class="container-fluid">
                <div class="grid grid-box grid-intro-home2">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-equipment1.jpg')">
                        ...
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-equipment2.jpg')">
                        ...
                        <div class="col-md-4">
                            <a href="#">
                                <div class="bg-r-overlay grid-item" style="background-image: url('images/grid-equipment3.jpg')">
        ...
        <div class="section bg-r-overlay section-contact section-contact-home" style="background-image: url('images/contact-home-bg.jpg')">
            <div class="container">
                <div class="content">
