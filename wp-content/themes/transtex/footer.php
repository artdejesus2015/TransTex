        ...
        <div class="container">
            <div class="grid-footer">
                <div class="row">
                    <div class="col-md-4">
                        <div class="grid-item">
                            <h3 class="grid-title"><span class="red">GAS</span> TREATING</h3>

                            <ul class="footer-list">
                                <li><a href="#">Amine Plants</a></li>
                                <li><a href="#">H2S Scavengers</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="grid-item">
                            <h3 class="grid-title"><span class="red">GAS</span> Processing</h3>
                    ...
                    <div class="col-md-4">
                        <div class="grid-item">
                            <h3 class="grid-title"><span class="red">PRODUCTION</span> EQUIPMENT</h3>
