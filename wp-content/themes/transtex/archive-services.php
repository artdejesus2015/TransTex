...
get_header();
    ...
    <div class="banner bg-r-overlay bg-fixed banner-sub banner-<?php $post_type = get_post_type( $post->ID ); echo $post_type;?> animatedParent" style="background-image: url('<?php echo $banner_bg; ?>')">
        <div class="banner_container">
            <div class="banner-caption animated fadeInDownShort"><?php the_field('services_banner_title', 'option') ?></div>
        </div>
    </div>
