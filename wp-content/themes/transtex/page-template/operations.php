...
?>
    ...
    <div class="banner bg-r-overlay banner-sub banner-<?php echo $post_slug;?>" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/banner-equipment.jpg')">
